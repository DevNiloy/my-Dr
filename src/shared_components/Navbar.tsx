    ...
    <nav className="bg-[#3B82F6] px-4 py-3 md:px-10">
      <div className="flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <button className="bg-white text-[#3B82F6] px-8 py-2 rounded-full font-bold text-sm hover:bg-gray-100 transition-all shadow-md">
            SIGN IN
          </button>
      ...
      {mobileMenuOpen && (
        <div className="lg:hidden mt-4 pb-4 space-y-4">
          ...
          <div className="pt-4 border-t border-blue-400 flex flex-col gap-4">
            <button className="bg-white text-[#3B82F6] w-full py-3 rounded-full font-bold">
              SIGN IN
            </button>
          </div>
        </div>
