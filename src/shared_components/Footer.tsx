    ...
    <footer className="bg-[#3B82F6] text-white py-12 px-6 lg:px-20">
      <div className="">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-2">
              ...
              <div className="w-10 h-10 border-2 border-white rounded-full flex items-center justify-center p-1">
                 <img src="/logo-white-stetho.svg" alt="MyDr" className="w-full h-full" />
              </div>
              <span className="text-3xl font-bold italic tracking-tighter">MyDr</span>
            </div>
            ...
            <div className="flex items-center gap-3 group cursor-pointer">
              ...
              <a href="mailto:kontakt@mydr.pl" className="hover:underline font-medium">kontakt@mydr.pl</a>
            </div>

            <p className="hover:underline cursor-pointer opacity-90 transition hover:opacity-100">Polityka prywatności</p>
          </div>
          ...
          <div className="space-y-6">
            <h3 className="text-xl font-bold uppercase tracking-wider">For Doctors</h3>
            <div className="space-y-4">
              ...
              <button className="bg-white/95 text-blue-600 px-6 py-3 rounded-full flex items-center gap-2 shadow-lg hover:bg-white transition-all transform active:scale-95 group">
                 <div className="w-6 h-6 border border-blue-400 rounded-full flex items-center justify-center p-0.5">
                    <img src="/blue-stetho.svg" alt="EDM" className="w-full h-full" />
                 </div>
                 <span className="font-bold italic">MyDr<span className="text-blue-400">EDM</span></span>
              </button>
            </div>
          </div>
